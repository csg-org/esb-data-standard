'''
EAVS Section B Data Standard documentation build configuration file
'''
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#
# EAVS Section B Data Standard documentation build configuration file, created by
...
copyright = '{}, Council of State Governments'.format(datetime.date.today().year)
...
htmlhelp_basename = 'EAVSSectionBDataStandarddoc'
